...
// Rest Routes
/*
 * Index - GET - /communities  - Presentational - respond with all communities
 * New - GET - /communities/new  - Presentational Form - a page with a form to create a new author
